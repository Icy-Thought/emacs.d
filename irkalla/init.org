...
#+begin_src emacs-lisp :tangle no
(irkalla/space-lead-keydef
  "t"   '(:ignore t               :which-key "Eshell")
  "t t" '(eshell                  :which-key "Start instance")
  "t p" '(eshell                  :which-key "Start project instance")
  "t c" '(eshell-life-is-too-much :which-key "Kill instance.."))

(irkalla/comma-lead-keydef
  "t"   '(:ignore t               :which-key "Eshell")
  "t n" '(nix-eshell              :which-key "Create Nix (Eshell) environment")
  "t c" '(eshell-kill-process     :which-key "Kill running process"))
#+end_src
...
**** Format-All: Pre-defined Auto Formatting (disabled)
