...
(use-package vertico-directory
  ...
  :general (general-nmap 'vertico-map
...
#+begin_src emacs-lisp
;;;###autoload
(defun irkalla/org-special-buf ()
  "Edit Org src-blocks in prog-mode for LSP."
  (interactive)
...
(use-package org
  ...
  (irkalla/comma-lead-keydef
    ...
    "o e" '(irkalla/org-special-buf :which-key "Edit -> special buffer")
