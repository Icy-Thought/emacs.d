...
(irkalla/comma-lead-keydef
  ...
  "f f" '(dirvish-side :which-key "Toggle Dirvish Side-View")
  "f /" '(dirvish-fd   :which-key "Run fd in Active Dir"))

(irkalla/comma-lead-keydef
  :keymaps 'dirvish-mode-map
  "a"   '(dirvish-quick-access        :which-key "Quick-access Frequently Used Dirs")
  "f"   '(dirvish-file-info-menu      :which-key "Get File Information")
  "y"   '(dirvish-yank-menu           :which-key "Yank Marked Files")
  "N"   '(dirvish-narrow              :which-key "Live Narrowing")
  "^"   '(dirvish-history-last        :which-key "Goto Most Recent Buffer")
  "h"   '(dirvish-history-jump        :which-key "Goto Recently Visited Dirs") ; remapped `describe-mode'
  "s"   '(dirvish-quicksort           :which-key "Sort Active Buffer") ; remapped `dired-sort-toggle-or-edit'
  "v"   '(dirvish-vc-menu             :which-key "Vision Control System") ; remapped `dired-view-file'
  "TAB" '(dirvish-subtree-toggle      :which-key "Toggle Dir as Sub-tree")
...
(use-package rust-mode
  ...
  :general
  (irkalla/comma-lead-keydef
    "r b"   '(rust-compile        :which-key "Compile Active Project")
    "r c"   '(rust-check          :which-key "")
    "r l"   '(rust-run-clippy     :which-key "")
    "r r"   '(rust-run            :which-key "Run Active Project")
...
(use-package cargo
  ...
  :general
  (irkalla/comma-lead-keydef
    "r p a" '(cargo-process-add   :which-key "")
    "r p c" '(cargo-process-clean :which-key ""))
