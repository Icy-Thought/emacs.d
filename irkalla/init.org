...
- [[#early-initialization-of-irkalla-emacs][Early Initialization of Irkalla Emacs]]
  ...
  - [[#early-decorations][Early Decorations]]
...
(add-to-list 'custom-theme-load-path (expand-file-name "colorschemes" user-emacs-directory))
#+end_src
...
#+begin_src emacs-lisp
(setq-default default-frame-alist '((font . "JetBrainsMono Nerd Font-13")))

(custom-set-faces
 '(default        ((t (:height 125 :weight semi-bold))))
 '(fixed-pitch    ((t (:height 105 :weight semi-bold :width expanded))))
 '(variable-pitch ((t (:height 105 :weight semi-bold)))))
...
(use-package dashboard
  ...
  :custom
  ;; :NOTE| UI-related changes
  (dashboard-display-icons-p t)
  (dashboard-icon-type 'nerd-icons)

  ;; :NOTE| Customizing dashboard setup
  ...
  ;; :NOTE| Quick-Navigation buttons for our dashboard
  ...
  ;; :NOTE| Controlling the state of our displayed items
...
(use-package nerd-icons
  :custom (nerd-icons-scale-factors 1.25))
#+end_src
...
(use-package svg-tag-mode
  :after svg-lib
  :hook ((markdown-mode org-mode text-mode) . svg-tag-mode)
  :config
  <<svg-tag-constants>>
