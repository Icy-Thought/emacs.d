...
- [[#early-initialization-of-irkalla-emacs][Early Initialization of Irkalla Emacs]]
  - [[#performance-related-changes][Performance-related Changes]]
  ...
  - [[#specifying-desired-options][Specifying Desired Options]]
  - [[#directories--encoding][Directories & Encoding]]
    - [[#defining-user-directories][Defining User Directories]]
    - [[#encoding-system---utf-8][Encoding System -> UTF-8]]
  - [[#preliminary-decorations][Preliminary Decorations]]
...
- [[#embarking-on-the-irkalla-journey-initialization][Embarking on the Irkalla Journey: Initialization.]]
  - [[#part-1-exploring-the-feasibility-of-emacs][Part 1: Exploring The Feasibility of Emacs]]
    - [[#managing-our-ever-growing-packages][Managing Our Ever-Growing Packages]]
    - [[#expanding-the-ever-growing-essential-pkgs][Expanding The Ever-Growing Essential Pkgs]]
    - [[#adjusting-several-behaviour-patterns][Adjusting Several Behaviour Patterns]]
    - [[#tweaking-built-in-aesthetics--functionality][Tweaking Built-in Aesthetics & Functionality]]
    - [[#unraveling-a-multitude-of-options][Unraveling a Multitude of Options]]
  - [[#part-2-experimenting-with-miraculous-pkgs][Part 2: Experimenting With Miraculous Pkgs]]
    ...
    - [[#integrating-social-necessities-to-irkalla][Integrating Social Necessities to Irkalla]]
...
** Specifying Desired Options

To view the documentation of a specific variable, refer to ~SPC h v~.
...
**** Migrating Custom-file -> =etc/custom.el=
...
** Preliminary Decorations

Firstly, we define our desired Irkalla Emacs font.
...
Afterwards, we inform Irkalla Emacs about our desired changes for it to apply them as requested!
...
*** Managing Our Ever-Growing Packages

**** Packages: Specifying Our Repositories
...
Later we modify our ~package.el~ & ~use-package~ for a more appropriate Emacs environment.
...
*** Expanding The Ever-Growing Essential Pkgs
...
***** (Emacs) Bindings For Our Peace of Mind
...
**** Direnv: Apply Local Environment Variables
...
*** Adjusting Several Behaviour Patterns
...
Our editing environment should become an environment we would like to spend our time in. Therefore I have chosen to apply several minor changes with the intentions of increasing the aesthetics of our editing environment by a small percentage!
...
Having a fancy ~buffer-face~ which we can toggle on demand would be an elegant way to enhance the aesthetics of our
reading experience. Therefore we shall add this missing feature!
...
**** Number-line: Enumerate Buffer Lines
...
**** Indent Bars: Highlight Code Indentations
