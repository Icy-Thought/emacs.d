...
- [[#embarking-on-the-irkalla-journey-initialization][Embarking on the Irkalla Journey: Initialization.]]
  - [[#the-beginning-of-irkalla-emacs][The Beginning of Irkalla Emacs]]
    ...
    - [[#modifying-irkallas-behaviour][Modifying Irkalla's Behaviour]]
    - [[#enhancing-the-aesthetics--functionality][Enhancing The Aesthetics & Functionality]]
...
*** Enhancing The Aesthetics & Functionality
...
(defun irkalla/connect-to-matrix ()
  ...
  (let* ((matrix-username "@gilganix:matrix.org"))
    (cond
      ((assoc-default matrix-username ement-sessions)
       (ement-room-list))
      ((ement--read-sessions)
