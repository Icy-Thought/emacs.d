...
* TODO: Actions
- [] (ORG-MODE) Rust babel
- [] Get svg-tag-mode to show in other filetypes besides org -> comments only!
- [] Corfu -> quit on escape
- [] Corfu -> show which completion suggestion candidate is selected after 4 tabs (atm -> vanish)
