...
(irkalla/space-lead-keydef
  ...
  "l ["        '(consult-flycheck       :which-key "Jump to Flycheck diagnostics")
...
**** Elfeed: An RSS-feed for the Madness
...
**** EShell: A Powerful Shell Which Understands Elisp!
:PROPERTIES:
:header-args+: :tangle no
:END:
...
**** Format-All: Quick Code Formatter
...
**** ChatGPT: Trained Machine Learning System
...
**** Yuck: Elkowar's Lisp Dialect for EWW
