...
(global-set-key (kbd "C-c [") 'main-hydra/body)
#+end_src
...
What remains is for us to write a conditional keybinding that spawns the appropriate hydra on demand.

#+begin_src emacs-lisp
(defun irkalla/cond-editor-hydra ()
  (interactive)
  (if (region-active-p)
      (call-interactively 'visual-editor-hydra/body)
    (call-interactively 'editor-hydra/body)))

(global-set-key (kbd "C-c ]") 'irkalla/cond-editor-hydra)
#+end_src
...
(defun meow-qwerty-setup ()
  ...
  (setq meow-selection-command-fallback
        '((meow-change . meow-change-char)
          (meow-kill . meow-delete) ;; alt. meow-C-k
  ...
  (meow-normal-define-key
   ...
   '("a" . meow-append)
   '("b" . meow-back-word)
   '("B" . backward-word) ;; alt. meow-back-symbol
   '("c" . meow-change)
   '("d" . meow-kill) ;; alt. meow-delete
   '("D" . meow-backward-delete)
   '("e" . meow-next-word)
   '("E" . forward-word) ;; alt. meow-next-symbol
   '("f" . meow-find)
   '("F" . consult-fd)
   '("g" . meow-join)
   '("h" . meow-left)
   ...
   '("t" . meow-till)
   '("u" . meow-undo)
   '("U" . undo-redo) ;; alt. meow-undo-in-selection
   '("v" . meow-block) ;; alt. meow-visit
   '("V" . meow-to-block)
   '("/" . consult-line)
   '("?" . comment-dwim)
   '("w" . meow-mark-word)
