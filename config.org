...
(use-package mu4e-dashboard
  ...
  :after (mu4e)
  :config
  (setq mu4e-dashboard-file (expand-file-name "mu4e/sidebar.org" irkalla/underworld))
  (setq-local visual-fill-column-mode nil)

  ;; :NOTE| Don't display Mu4e-View after :q mu4e-dashboard
  (advice-add 'mu4e--main-view :around
...
(use-package yasnippet
  ...
  :hook (corfu-mode . yas-global-mode)
  :config
