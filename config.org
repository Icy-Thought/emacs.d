...
To reduce the burden of setting up multiple accounts, let's borrow the superpowers of ~mu4easy~.
...
(use-package yasnippet
  ...
  :init (add-to-list 'yas-snippet-dirs (concat irkalla/underworld "/snippets")))
#+end_src
