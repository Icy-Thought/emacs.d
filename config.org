    ...
    (setf (alist-get 'clang-format apheleia-formatters)
          `("clang-format" "-assume-filename"
            (or (apheleia-formatters-local-buffer-file-name)
                ...
                ".c")
            (format "--style={IndentWidth: %d}" tab-width)))
    (add-to-list 'apheleia-mode-alist '((c-mode c-ts-mode) . clang-format))
    (add-to-list 'apheleia-mode-alist '((c++-mode c++-ts-mode) . clang-format))))
#+end_src
...
(when (executable-find "stylua")
  (with-eval-after-load 'apheleia
    ...
    (add-to-list 'apheleia-mode-alist '((lua-mode lua-ts-mode) . stylua))))
#+end_src
...
(when (executable-find "ruff")
  (with-eval-after-load 'apheleia
    (add-to-list 'apheleia-mode-alist '((python-mode python-ts-mode) . ruff))
    (add-to-list 'apheleia-mode-alist '((python-mode python-ts-mode) . ruff-isort))))
#+end_src
