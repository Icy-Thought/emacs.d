...
(use-package popper
  ...
  (popper-reference-buffers
   '(help-mode helpful-mode
     "\\*Messages\\*" "^\\*apheleia.*\\*$"
     "\\*Async Shell Command\\*" "*Python*"
     compilation-mode "Output\\*$" "\\*.*REPL.*\\*"
...
(use-package shackle
  ...
  (shackle-rules
   `((help-mode                       :align right :popup t :select t :size 0.45)
     (helpful-mode                    :align right :popup t :select t :size 0.45)
     (compilation-mode                :align right :popup t)
     (cargo-process-mode              :align right :popup t)
     (flymake-diagnostics-buffer-mode :align below :popup t)
     (magit-process-mode              :align below :popup t)
     ("*Async-native-compile-log*"    :align right :popup t)
     ("*Messages*"                    :align below :popup t)
     ("*eldoc*"                       :align right :popup t)
     ("*Python*"                      :align right :popup t)
     ("Output\\*$"                    :align right :popup t :regexp t)
     ("^\\*apheleia.*\\*$"            :align right :popup t :regexp t)
     ("\\*.*REPL.*\\*"                :align right :popup t :regexp t)
     ("^\\*eat.*\\*$"                 :align below :select t :regexp t :size 0.45)
     ("^\\*eshell.*\\*$"              :align below :select t :regexp t :size 0.45)
     ("^\\*shell.*\\*$"               :align below :select t :regexp t :size 0.45)
     ("^\\*term.*\\*$"                :align below :select t :regexp t :size 0.45)
     ("^\\*vterm.*\\*$"               :align below :select t :regexp t :size 0.45))))
#+end_src
...
***** NeoTree: Tree-based Directory Navigation

#+begin_src emacs-lisp
(use-package neotree
  :after (nerd-icons)
  :bind ([remap dired] . neotree-toggle)
  :custom
  (neo-theme (if (display-graphic-p) 'nerd-icons 'classic))
