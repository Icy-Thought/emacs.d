...
- [[#core-configurations][Core Configuration(s)]]
  - [[#part-1-elpaca-package-manager][Part-1: Elpaca Package Manager]]
  - [[#part-2-wrapping-up-core-changes][Part 2: Wrapping Up Core Changes]]
- [[#powering-up-with-packages][Powering Up with Packages]]
  - [[#part-1-beginning-of-a-journey][Part 1: Beginning Of A Journey]]
    - [[#automatically-compile-conf][Automatically Compile Conf]]
...
Also, we should prefer to load newer files.
...
** Part 2: Wrapping Up Core Changes
...
* Powering Up with Packages
:PROPERTIES:
:HEADER-ARGS: :tangle ~/.config/emacs/packages.el
:END:

#+begin_src emacs-lisp
;;; packages.el --- The endless hunt for packages -*- lexical-binding: t; -*-
...
;;; Commentary:
;; The file that harbors the packages that survived the experimentations with my workflow.
